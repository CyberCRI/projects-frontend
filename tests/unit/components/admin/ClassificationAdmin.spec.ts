...
describe('ClassificationAdmin', () => {
  ...
  it('should ask confirmation for deleting classification', async () => {
    ...
    const vm: any = wrapper.vm
    await flushPromises()
    const deleteButtons = wrapper.findAllComponents('[data-test="delete-classification-button"]')
    let confirmModal = wrapper.findComponent('[data-test="confirm-delete-classification-modal"]')
