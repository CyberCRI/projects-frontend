      ...
      <div class="container">
        ...
        <div class="des">
          ...
          <i18n-t keypath="about.WHY.des2" tag="p">
            <a href="http://projects.directory" place="link">{{ $t('about.WHY.platform') }}</a>
          </i18n-t>
        </div>
        ...
        <ul class="people">
          <li v-for="(coreTeamPerson, index) in coreTeam" :key="index" class="person">
            <a :href="`${peopleUrl}/people/${coreTeamPerson.id}`" target="_blank">
              ...
              <span class="name" v-html="coreTeamPerson.name" />

              <span class="title">{{ $t(`about.TEAM_CORE.list[${index}].title`) }}</span>
        ...
        <ul class="people">
          <li v-for="(contributor, index) in contributors" :key="index" class="person">
            <a :href="`${peopleUrl}/people/${contributor.id}`" target="_blank">
              ...
              <span class="name" v-html="contributor.name" />

              <span class="title">{{ $t(`about.TEAM_CONTRIB.list[${index}].title`) }}</span>

              <span class="des">{{ $t(`about.TEAM_CONTRIB.list[${index}].des`) }}</span>
            </a>
          </li>
        </ul>
      </div>
