<template>
    <div class="onboarding-todo-block" :class="{ collapsed }">
        <span class="plateform-tour-button" v-if="collapsed" @click="collapse = false">
            <span>{{ $t('onboarding-todo.platform-tour') }}</span>
            <LpiButton class="arrow-btn" btn-icon="ArrowRight" secondary />
        </span>

        <div class="onboarding-todos">
            <LpiButton class="close-btn" btn-icon="Close" secondary @click="collapse = true" />
            ...
            <ul class="todo-list">
                ...
                <OnboardingTodo :todo-label="$t('onboarding-todo.take-tour')" :todo-done="false">
