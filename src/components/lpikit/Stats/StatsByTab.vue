...
import ProjectsByOrg from './Charts/ProjectsByOrg.vue'
import SdgChart from './Charts/SdgChart.vue'
import TagChart from './Charts/TagChart.vue'
import LpiLoader from '../Loader/LoaderSimple.vue'
import TimeOrgChart from './Charts/TimeOrgChart.vue'
