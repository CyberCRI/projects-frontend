...
import FilterWrapper from '@/components/lpikit/Filters/FilterWrapper.vue'
...
import SkillsFilterSummary from '@/components/lpikit/Skills/SkillsFilterSummary.vue'
import SkillsFilterEditor from '@/components/lpikit/Skills/SkillsFilterEditor.vue'
