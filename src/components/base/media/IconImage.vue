<template>
    <svg @click="$emit('click')" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path
            v-if="name === 'Account'"
            d="M12,4A4,4 0 0,1 16,8A4,4 0 0,1 12,12A4,4 0 0,1 8,8A4,4 0 0,1 12,4M12,14C16.42,14 20,15.79 20,18V20H4V18C4,15.79 7.58,14 12,14Z"
        />

        <path v-else-if="name === 'Alert'" d="M13 14H11V9H13M13 18H11V16H13M1 21H23L12 2L1 21Z" />

        <path
            v-else-if="name === 'AlertOutline'"
            d="M12,2L1,21H23M12,6L19.53,19H4.47M11,10V14H13V10M11,16V18H13V16"
        />

        <path
            v-else-if="name === 'ArrowLeft'"
            d="M20,11V13H8L13.5,18.5L12.08,19.92L4.16,12L12.08,4.08L13.5,5.5L8,11H20Z"
        />

        <path
            v-else-if="name === 'ArrowRight'"
            d="M4,11V13H16L10.5,18.5L11.92,19.92L19.84,12L11.92,4.08L10.5,5.5L16,11H4Z"
        />

        <path
            v-else-if="name === 'ArrowUpRightFromSquare'"
        ...
        <path
            v-else-if="name === 'DotsHorizontal'"
            d="M16,12A2,2 0 0,1 18,10A2,2 0 0,1 20,12A2,2 0 0,1 18,14A2,2 0 0,1 16,12M10,12A2,2 0 0,1 12,10A2,2 0 0,1 14,12A2,2 0 0,1 12,14A2,2 0 0,1 10,12M4,12A2,2 0 0,1 6,10A2,2 0 0,1 8,12A2,2 0 0,1 6,14A2,2 0 0,1 4,12Z"
        />

        <path
            v-else-if="name === 'Earth'"
        ...
        <path
            v-else-if="name === 'EmailOutline'"
            d="M22 6C22 4.9 21.1 4 20 4H4C2.9 4 2 4.9 2 6V18C2 19.1 2.9 20 4 20H20C21.1 20 22 19.1 22 18V6M20 6L12 11L4 6H20M20 18H4V8L12 13L20 8V18Z"
        />

        <path
            v-else-if="name === 'ExclamationMark'"
        ...
        <path
            v-else-if="name === 'FileTreeOutline'"
        ...
        <path v-else-if="name === 'Flag'" d="M14.4,6L14,4H5V21H7V14H12.6L13,16H20V6H14.4Z" />
        ...
        <path
            v-else-if="name === 'MapMarker'"
            d="M12,11.5A2.5,2.5 0 0,1 9.5,9A2.5,2.5 0 0,1 12,6.5A2.5,2.5 0 0,1 14.5,9A2.5,2.5 0 0,1 12,11.5M12,2A7,7 0 0,0 5,9C5,14.25 12,22 12,22C12,22 19,14.25 19,9A7,7 0 0,0 12,2Z"
        />

        <path v-else-if="name === 'MenuDown'" d="M7,10L12,15L17,10H7Z" />

        <path v-else-if="name === 'MenuUp'" d="M7,15L12,10L17,15H7Z" />

        <path v-else-if="name === 'Minus'" d="M19,13H5V11H19V13Z" />

        <path
            v-else-if="name === 'MultiplePerson'"
        ...
        <path v-else-if="name === 'Plus'" d="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z" />

        <path v-else-if="name === 'Poll'" d="M3,22V8H7V22H3M10,22V2H14V22H10M17,22V14H21V22H17Z" />

        <path
            v-else-if="name === 'QuestionMark'"
        ...
        <path v-else-if="name === 'Spinner'" d="M12,4V2A10,10 0 0,0 2,12H4A8,8 0 0,1 12,4Z" />

        <path
            v-else-if="name === 'TrashCanOutline'"
        ...
        <path v-else-if="name === 'Upload'" d="M9,16V10H5L12,3L19,10H15V16H9M5,20V18H19V20H5Z" />
        ...
        />
        <path
            v-else-if="name == 'CheckBoxOutline'"
            d="M9,20.42L2.79,14.21L5.62,11.38L9,14.77L18.88,4.88L21.71,7.71L9,20.42Z"
        />
        <path
            v-else-if="name == 'CheckBoxBlankOutline'"
            d="M19,3H5C3.89,3 3,3.89 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5C21,3.89 20.1,3 19,3M19,5V19H5V5H19Z"
        />

        <path
            v-else-if="name == 'CropFree'"
        ...
        <path
            v-else-if="name == 'BookmarkBoxOutline'"
        ...
        <path
            v-else-if="name == 'BullhornOutline'"
        ...
        />
        <path
            v-else-if="name == 'School'"
            d="M12,3L1,9L12,15L21,10.09V17H23V9M5,13.18V17.18L12,21L19,17.18V13.18L12,17L5,13.18Z"
        />

        <path
            v-else-if="name == 'TextBoxOutline'"
            d="M5,3C3.89,3 3,3.89 3,5V19C3,20.11 3.89,21 5,21H19C20.11,21 21,20.11 21,19V5C21,3.89 20.11,3 19,3H5M5,5H19V19H5V5M7,7V9H17V7H7M7,11V13H17V11H7M7,15V17H14V15H7Z"
        />
    </svg>
</template>
