...
export const useProjectTabs = (
  ...
  const TabsDisplay = computed(() => {
    return [
      ...
      {
        key: 'project-groups',
        label: t(ProjectModuleTitle.groups, modules.value.groups),
      ...
      },
      {
        ...
        label: t(ProjectModuleTitle.resources, modules.value.files + modules.value.links),
        ...
        icon: ProjectModuleIcon.resources,
      },
      {
