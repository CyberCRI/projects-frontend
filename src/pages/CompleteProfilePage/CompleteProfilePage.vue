<template>
    <DrawerLayout :is-opened="true" title="" @close="cancel" class="full" :padding="false">
...
import CompleteProfileStep1 from '@/pages/CompleteProfilePage/CompleteProfileStep1.vue'
import CompleteProfileStep2 from '@/pages/CompleteProfilePage/CompleteProfileStep2.vue'
export default {
